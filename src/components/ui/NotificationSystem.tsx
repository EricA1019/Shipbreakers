            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                ...
                {notification.details && (
                  <div className="text-xs mt-1 opacity-80">{notification.details}</div>
                )}
              </div>
            </div>
          </div>
...
let globalAddNotification: NotificationContextType['addNotification'] | null = null;

export function setGlobalNotificationHandler(handler: NotificationContextType['addNotification']) {
